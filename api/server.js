...
import integrationsHubRoutes from "./routes/integrations.routes.js";
...
import aiEngineerRoutes from "./routes/aiEngineer.routes.js";
...
app.register(aiEngineerRoutes, { prefix: "/api/ai-engineer" });
...
app.register(costingRoutes, { prefix: "/api/costing" });
app.register(entityRoutes, { prefix: "/api/entity" });
app.register(integrationsHubRoutes, { prefix: "/api/integrations" });
app.register(governanceRoutes, { prefix: "/api/governance" });
app.register(executiveRoutes, { prefix: "/api/executive" });
